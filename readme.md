## Introduction_Training_PrintHelloWorld
Print something to the console of SICK AppStudio
...
The purpose of this one is to show the first basic step of how to print
something like "Hello world!" to the console of SICK AppStudio.

### Topics
training, introduction, print, lua, sampleapp, sick-appspace
